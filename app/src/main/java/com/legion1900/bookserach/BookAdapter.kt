...
class BookAdapter(context: Context, var dataSource: List<Work>) : RecyclerView.Adapter<BookAdapter.BookViewHolder>() {
    ...
    class BookViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val avgRating: TextView = itemView.findViewById<TextView>(R.id.avg_rating)
    }
